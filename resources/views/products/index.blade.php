    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="table-responsive-sm table-responsive-md">
                ...
                <a type="button" href="{{ route('stock') }}" style="float: right; margin-right: 10px;" class="bg-green-500 px-12 py-2 rounded text-gray-200 font-semibold hover:bg-green-600 transition duration-200 each-in-out">
